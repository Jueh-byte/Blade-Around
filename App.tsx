...
import { Play, RotateCcw, Shield, Flame, BrainCircuit, Volume2, VolumeX } from 'lucide-react';
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-gray-900 text-white font-sans">
      ...
      <button 
        ...
        className="absolute top-4 right-4 z-50 bg-black/40 p-2 rounded-full hover:bg-black/60"
      >
      ...
      {gameState === GameState.MENU && (
        <div className="absolute inset-0 z-50 bg-gray-900 flex items-center justify-center p-4">
          <div className="max-w-md w-full bg-gray-800 p-8 rounded-2xl border-2 border-yellow-600/50 shadow-[0_0_50px_rgba(234,88,12,0.5)] text-center">
